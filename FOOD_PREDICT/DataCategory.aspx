<%@ Page Language="C#" MasterPageFile="~/User.master"  AutoEventWireup="true" CodeFile="DataCategory.aspx.cs" Inherits="AdminApartment" %>
...
<br />
<asp:Button ID="btnAddPack" runat="server" Text="Add New Category Entry" 
...
<h3>Add New Category Entry</h3>
<table>
<tr><td>Category Name</td><td><asp:TextBox ID="TxtName" runat="server"></asp:TextBox></td></tr>
