...
public partial class SymtomEntry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                PackListBind();
                cls1.Combo_Bind(Catename, "Select * from TblCateEntry", "CateName");
            }
        }
        catch (Exception ex)
        {
    ...
    public void PackListBind()
    {
        try
        {
            Qry1 = "select * from TblSymtom";
            if (cls1.record_availability(Qry1))
            {
                PackList.Visible = true;
                dst1 = cls1.bnd("select * from TblSymtom");
    ...
    protected void PackList_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            dst1 = cls1.bnd("select * from TblSymtom where RecID=" + RecID + "");
            dt1 = dst1.Tables[0];
    ...
    protected void PackList_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Qry1 = "Delete from TblSymtom where RecID=" + Convert.ToInt32(PackList.DataKeys[e.RowIndex].Value.ToString()) + "";
    ...
    protected void btnInsertPack_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Qry2 = "insert into TblSymtom values ('" + Catename.SelectedItem.Text + "' ,'"+ TxtName.Text+"')";
